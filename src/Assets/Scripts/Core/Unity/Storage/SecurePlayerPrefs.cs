...
namespace Core.Unity.Storage
{
    public static class SecurePlayerPrefs
    {
        ...
        static string strPassword = "IvmGWTGTcg!123";
        static string strSalt = "Ivfe323B12";
        ...
        {
            string strEncryptValue = GetRawString(key);
        ...
        {
            string strEncryptValue = GetRawString(key, defaultValue);
            return Decrypt(strEncryptValue, strPassword);
        }

        public static string GetRawString(string key, string defaultValue)
        {
            CheckPasswordSet();
